...
`define SDF_FILE "./Netlist/alu_syn.sdf"
...
`elsif I9
    ...
    `define PAT_NUM 40    
`elsif I10
    `define Inst_I "../HiddenCasePattern/INST_I_h.dat"
    `define Inst_O "../HiddenCasePattern/INST_O_h.dat"
...
module testbed;
    ...
    `ifdef SDF
        initial $sdf_annotate(`SDF_FILE, u_alu);
    `endif
